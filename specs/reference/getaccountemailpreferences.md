...
```json
{
  "components": {
    "schemas": {
      "email_preferences_response": {
        "title": "email_preferences_response",
        "type": "string",
  ...
  "paths": {
    "/account/email-preferences": {
      "get": {
        "summary": "GET /account/email-preferences",
        "tags": [
          "Private API"
        ],
        "security": [
        ...
        "operationId": "GetAccountEmailPreferences",
        ...
        "responses": {
          "200": {
            ...
            "content": {
              "application/json": {
                "schema": {
                  "title": "GetAccountEmailPreferences200Response",
                  "type": "object",
                  "properties": {
                    "email_preferences": {
                      "$ref": "#/components/schemas/email_preferences_response"
                    }
                  },
                  "required": [
                    "email_preferences"
