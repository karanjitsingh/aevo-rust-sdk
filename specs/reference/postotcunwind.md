  ...
  "components": {
    "schemas": {
      ...
      "otc_id": {
        "title": "otc_id",
        "type": "integer",
        "description": "Unique ID of the otc request",
        "example": 1
      },
      "success_response": {
  ...
  "paths": {
    "/otc/unwind": {
      "post": {
        ...
        "operationId": "PostOtcUnwind",
        "description": "Unwind an otc position",
        "responses": {
          "200": {
            "description": "Whether or not position was successfully unwound",
            "content": {
              "application/json": {
                "schema": {
                  "title": "PostOtcUnwind200Response",
                  "type": "object",
                  "properties": {
                    "success": {
        ...
        "requestBody": {
          "content": {
            "application/json": {
              "schema": {
                "title": "PostOtcUnwindPayload",
                "type": "object",
                "properties": {
                  "otc_id": {
                    "$ref": "#/components/schemas/otc_id"
                  }
                },
                "required": [
                  "otc_id"
