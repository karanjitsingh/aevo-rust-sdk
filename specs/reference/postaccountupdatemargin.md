...
```json
{
  "components": {
    "schemas": {
      ...
      "isolated_margin": {
        "title": "isolated_margin",
        "type": "string",
        "description": "The change in isolated margin assigned to a position. In 6 decimals fixed number. Negative allowed.",
        "example": "10000000"
      },
  ...
  "paths": {
    "/account/update-margin": {
      "post": {
        "summary": "POST /account/update-margin",
        "tags": [
          "Private API"
        ],
        "security": [
        ...
        "operationId": "PostAccountUpdateMargin",
        ...
        "responses": {
          "200": {
            ...
            "content": {
              "application/json": {
                "schema": {
                  "title": "PostAccountUpdateMargin200Response",
                  "type": "object",
                  "properties": {
                    "success": {
                      "type": "object",
        ...
        "requestBody": {
          "content": {
            "application/json": {
              "schema": {
                "title": "PostAccountUpdateMarginPayload",
                "type": "object",
                "properties": {
                  "instrument": {
                  ...
                  "isolated_margin": {
                    "$ref": "#/components/schemas/isolated_margin"
                  }
                },
                "required": [
                  "instrument",
