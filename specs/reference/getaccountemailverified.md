...
```json
{
  ...
  "paths": {
    "/account/email-verified": {
      "get": {
        "summary": "GET /account/email-verified",
        "tags": [
          "Private API"
        ],
        "security": [
        ...
        "operationId": "GetAccountEmailVerified",
        ...
        "responses": {
          "200": {
            ...
            "content": {
              "application/json": {
                "schema": {
                  "title": "GetAccountEmailVerified200Response",
                  "type": "object",
                  "properties": {
                    "email_verified": {
                      "$ref": "#/components/schemas/email_verified_response"
                    }
                  },
                  "required": [
                    "email_verified"
