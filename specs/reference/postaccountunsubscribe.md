...
```json
{
  ...
  "paths": {
    "/account/unsubscribe": {
      "post": {
        "summary": "POST /account/unsubscribe",
        "tags": [
          "Public API"
        ],
        "operationId": "PostAccountUnsubscribe",
        ...
        "responses": {
          "200": {
            ...
            "content": {
              "application/json": {
                "schema": {
                  "title": "PostAccountUnsubscribe200Response",
                  "type": "object",
                  "properties": {
                    "success": {
        ...
        "requestBody": {
          "content": {
            "application/json": {
              "schema": {
                "title": "PostAccountUnsubscribePayload",
                "type": "object",
                "properties": {
                  "account": {
                  ...
                  "email_auth_token": {
                    "$ref": "#/components/schemas/email_auth_token"
                  }
                },
                "required": [
                  "account",
